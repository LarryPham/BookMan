...
public class MREvent implements Parcelable {
    ...
    public String toString() {
        ...
        switch(motion) {
            ...
            case TWO_TAPPING                      : string += "TWO_TAPPING"                      ; break;
            case SNAP_X_POSITIVE                  : string += "SNAP_X_POSITIVE"                  ; break;
            case SNAP_X_NEGATIVE                  : string += "SNAP_X_NEGATIVE"                  ; break;
            case SNAP_Y_POSITIVE                  : string += "SNAP_Y_POSITIVE"                  ; break;
            case SNAP_Y_NEGATIVE                  : string += "SNAP_Y_NEGATIVE"                  ; break;
            case SNAP_Z_POSITIVE                  : string += "SNAP_Z_POSITIVE"                  ; break;
            case SNAP_Z_NEGATIVE                  : string += "SNAP_Z_NEGATIVE"                  ; break;
            case SPEAKER_PHONE_ON                 : string += "SPEAKER_PHONE_ON"                 ; break;
            case SPEAKER_PHONE_OFF                : string += "SPEAKER_PHONE_OFF"                ; break;
            case FLIP_TOP_TO_BOTTOM               : string += "FLIP_TOP_TO_BOTTOM"               ; break;
            case TILT_PORTRAIT_FRONT              : string += "TILT_PORTRAIT_FRONT"              ; break;
            case TILT_PORTRAIT_BACK               : string += "TILT_PORTRAIT_BACK"               ; break;
            case TILT_PORTRAIT_FRONT_BACK_STOP    : string += "TILT_PORTRAIT_FRONT_BACK_STOP"    ; break;
            case TILT_PORTRAIT_LEFT               : string += "TILT_PORTRAIT_LEFT"               ; break;
            case TILT_PORTRAIT_RIGHT              : string += "TILT_PORTRAIT_RIGHT"              ; break;
            case TILT_PORTRAIT_LEFT_RIGHT_STOP    : string += "TILT_PORTRAIT_LEFT_RIGHT_STOP"    ; break;
            case TILT_LANDSCAPE_LEFT_LEVEL_1      : string += "TILT_LANDSCAPE_LEFT_LEVEL_1"      ; break;
            case TILT_LANDSCAPE_LEFT_LEVEL_2      : string += "TILT_LANDSCAPE_LEFT_LEVEL_2"      ; break;
            case TILT_LANDSCAPE_RIGHT_LEVEL_1     : string += "TILT_LANDSCAPE_RIGHT_LEVEL_1"     ; break;
            case TILT_LANDSCAPE_RIGHT_LEVEL_2     : string += "TILT_LANDSCAPE_RIGHT_LEVEL_2"     ; break;
            case TILT_LANDSCAPE_LEFT_RIGHT_STOP   : string += "TILT_LANDSCAPE_LEFT_RIGHT_STOP"   ; break;
            case TILT_FRONT                       : string += "TILT_FRONT"                       ; break;
            case TILT_BACK                        : string += "TILT_BACK"                        ; break;
            case TILT_FRONT_BACK_END              : string += "TILT_FRONT_BACK_END"              ; break;
            case TILT_LEFT                        : string += "TILT_LEFT"                        ; break;
            case TILT_RIGHT                       : string += "TILT_RIGHT"                       ; break;
            case TILT_LEFT_RIGHT_END              : string += "TILT_LEFT_RIGHT_END"              ; break;
            case ROTATE_0                         : string += "ROTATE_0"                         ; break;
            case ROTATE_90                        : string += "ROTATE_90"                        ; break;
            case ROTATE_180                       : string += "ROTATE_180"                       ; break;
            case ROTATE_270                       : string += "ROTATE_270"                       ; break;
            case ROTATE_START                     : string += "ROTATE_START"                     ; break;
            case ROTATE_STOP                      : string += "ROTATE_STOP"                      ; break;
            case SHAKE                            : string += "SHAKE"                            ; break;
            case SHAKE_START                      : string += "SHAKE_START"                      ; break;
            case SHAKE_STOP                       : string += "SHAKE_STOP"                       ; break;
            case SHORT_SHAKE                      : string += "SHORT_SHAKE"                      ; break;
            case SHORT_SHAKE_START                : string += "SHORT_SHAKE_START"                ; break;
            case SHORT_SHAKE_STOP                 : string += "SHORT_SHAKE_STOP"                 ; break;
            case BT_SHARING_RECEIVE_READY         : string += "BT_SHARING_RECEIVE_READY"         ; break;
            case BT_SHARING_RECEIVE_NOT_READY     : string += "BT_SHARING_RECEIVE_NOT_READY"     ; break;
            case BT_SHARING_SEND_START            : string += "BT_SHARING_SEND_START"            ; break;
            case BT_SHARING_SEND_PAUSE            : string += "BT_SHARING_SEND_PAUSE"            ; break;
            case BT_SHARING_SEND_STOP             : string += "BT_SHARING_SEND_STOP"             ; break;
            case ROTATE_HORIZONTAL                : string += "ROTATE_HORIZONTAL"                ; break;
            case BOUNCE                           : string += "BOUNCE"                           ; break;
            case SNAP1_X_POSITIVE                 : string += "SNAP1_X_POSITIVE"                 ; break;
            case SNAP1_X_NEGATIVE                 : string += "SNAP1_X_NEGATIVE"                 ; break;
            case SNAP1_Y_POSITIVE                 : string += "SNAP1_Y_POSITIVE"                 ; break;
            case SNAP1_Y_NEGATIVE                 : string += "SNAP1_Y_NEGATIVE"                 ; break;
            case SNAP1_Z_POSITIVE                 : string += "SNAP1_Z_POSITIVE"                 ; break;
            case SNAP1_Z_NEGATIVE                 : string += "SNAP1_Z_NEGATIVE"                 ; break;
            case SNAP2_X_POSITIVE                 : string += "SNAP2_X_POSITIVE"                 ; break;
            case SNAP2_X_NEGATIVE                 : string += "SNAP2_X_NEGATIVE"                 ; break;
            case SNAP2_Y_POSITIVE                 : string += "SNAP2_Y_POSITIVE"                 ; break;
            case SNAP2_Y_NEGATIVE                 : string += "SNAP2_Y_NEGATIVE"                 ; break;
            case SNAP2_Z_POSITIVE                 : string += "SNAP2_Z_POSITIVE"                 ; break;
            case SNAP2_Z_NEGATIVE                 : string += "SNAP2_Z_NEGATIVE"                 ; break;
            case SNAP_LEFT                        : string += "SNAP_LEFT"                        ; break;
            case SNAP_RIGHT                       : string += "SNAP_RIGHT"                       ; break;
            case PANNING_GYRO                     : string += "PANNING_GYRO"                     ; break;
            case ONE_TAPPING_GYRO                 : string += "ONE_TAPPING_GYRO"                 ; break;
            case TWO_TAPPING_GYRO                 : string += "TWO_TAPPING_GYRO"                 ; break;
            case ONE_TIPPING_GYRO                 : string += "ONE_TIPPING_GYRO"                 ; break;
            case TWO_TIPPING_GYRO                 : string += "TWO_TIPPING_GYRO"                 ; break;
            case BLOW                             : string += "BLOW"                             ; break;
            case TILT                             : string += "TILT"                             ; break;
            case MAX                              : string += "MAX"                              ; break;
        }
        string = string.trim();
