 ...
 * @author Larry Pham
 * @since 2014.10.02
 * Using the ActivityActionCounter object for determining the actions will be handled into the Views components
 * and requesting the actions from activities to controllers, and other components.
 *
 * For managing the work-flow for current project, we need to determine the amount of actions, which will be handled
 * or be destructed
 */
