...
public class Action implements Parcelable {
  ...
  public static final String
      REQUEST_OWNER =
      "com.techiedb.app.bookman.actions.ACTION_REQUEST_OWNER";
  public static final String REQUEST_MSG = "com.techiedb.app.bookman.actions.ACTION_REQUEST_MSG";

  public static final String
      LOAD_GALLERY_PAGE =
      "com.techiedb.app.bookman.actions.ACTION_LOAD_GALLERY_PAGE";
  public static final String
      LOAD_CONTENT_PARTIAL =
      "com.techiedb.app.bookman.actions.ACTION_LOAD_CONTENT_PARTIAL";
  public static final String
      LOAD_CONTENT_ALL =
      "com.techiedb.app.bookman.actions.ACTION_LOAD_CONTENT_ALL";
  public static final String
      LOADING_IMAGE =
      "com.techiedb.app.bookman.actions.ACTION_LOADING_IMAGE";
  public static final String LOADING_SIZE = "com.techiedb.app.bookman.actions.ACTION_LOADING_SIZE";

  public static final String
      CANCEL_DOWNLOAD_CONTENT =
      "com.techiedb.app.bookman.actions.ACTION_CANCEL_DOWNLOAD_CONTENT";
  public static final String
      CANCEL_ALL_DOWNLOAD_CONTENT =
      "com.techiedb.app.bookman.actions.ACTION_CANCEL_ALL_DOWNLOAD_CONTENT";
  ...
  public static final String
      PUBLISHER_ID =
      "com.techiedb.app.bookman.actions.ACTION_BINDING_PUBLISHER_ID";
  public static final String
      AUTHOR_ID =
      "com.techiedb.app.bookman.actions.ACTION_BINDING_AUTHOR_ID";
  public static final String
      IS_NOTICE =
      "com.techiedb.app.bookman.actions.ACTION_REQUEST_NOTICE_FROM_SERVER";

  public static final String
      DISMISS_DIALOG =
      "com.techiedb.app.bookman.actions.ACTION_DISMISS_DIALOG";
  public static final String SHOW_DIALOG = "com.techiedb.app.bookman.actions.ACTION_SHOW_DIALOG";
  public static final String
      SHOW_PROGRESS_DURATION =
      "com.techiedb.app.bookman.actions.ACTION_SHOW_PROGRESS_DURATION";
  public static final String
      PULL_REFRESH_TO_REQUEST =
      "com.techiedb.app.bookman.actions.ACTION_PULL_TO_REFRESH_REQUEST";
  public static final String
      REQUEST_TO_LOADING_MORE =
      "com.techiedb.app.bookman.actions.ACTION_REQUEST_TO_LOADING_MORE";
  public static final String
      CLIENT_DEVICES =
      "com.techiedb.app.bookman.actions.REQUEST_CLIENT_DEVICES";
  ...
  public static final String
      REQUEST_TO_SERVER_EBOOKS_LIST =
      "com.techiedb.app.bookman.actions.REQUEST_TO_SERVER_EBOOKS_LIST";
  public static final String
      REQUEST_TO_SERVER_EBOOK_INFO =
      "com.techiedb.app.bookman.actions.REQUEST_TO_SERVER_EBOOK_INFO";

  public static final String
      REQUEST_TO_SERVER_EBOOKS_AUTHOR_KEYWORD =
      "com.techiedb.app.bookman.actions.REQUEST_TO_SERVER_EBOOKS_AUTHOR_KEYWORD";
  public static final String
      REQUEST_TO_SERVER_EBOOKS_PUBLISHER_KEYWORD =
      "com.techiedb.app.bookman.actions.REQUEST_TO_SERVER_EBOOKS_PUBLISHER_KEYWORD";
  public static final String
      REQUEST_TO_SERVER_EBOOKS_KEYWORD =
      "com.techiedb.app.bookman.actions.REQUEST_TO_SERVER_EBOOKS_KEYWORD";
  ...
  public static final String
      SHOW_ERROR_DIALOG =
      "com.techiedb.app.bookman.actions.SHOW_ERROR_DIALOG";
  public static final String
      DISMISS_ERROR_DIALOG =
      "com.techiedb.app.bookman.actions.DISMISS_ERROR_DIALOG";
  public static final String
      SHOW_RESPONE_TIME =
      "com.techiedb.app.bookman.actions.SHOW_RESPONSE_TIME";
