 ...
 * @since Dec.19.2014
 */
public class SearchActivityControler extends BaseController {
    protected static final String TAG = Properties.PREFIX + SearchActivityControler.class.getSimpleName();

    public SearchActivityControler(BaseActivity activity, BookDataModel inDataModel) {
        super(activity, inDataModel);
    }

    public SearchActivityControler(BaseActivity activity, BookDataModel inDataModel, boolean blnFirstRunning) {
