 ...
 *
 * @author Larry Pham
 * @since 2014.10.08 Using the android-system properties for reflecting the methods from android packages.
 */
public class AndroidSystemProperties {
  ...
  static {
    try {
      Class<?>
          clazz =
          AndroidSystemProperties.class.getClassLoader().loadClass("android.os.SystemProperties");
