 ...
 * @since Dec.19.2014
 */
public class BrowserDetailActivityController extends BaseController {
    public static final String TAG = Properties.PREFIX + BrowserDetailActivityController.class.getSimpleName();

    public BrowserDetailActivityController(BaseActivity activity, BookDataModel inDataModel) {
        super(activity, inDataModel);
    }

    public BrowserDetailActivityController(BaseActivity activity, BookDataModel inDataModel, boolean blnFirstRunning) {
