...
public class ControllerMessage {
  ...
  public static final int
      REQUEST_TO_SUBSCRIBE_EBOOK_AUTHORITIES_FAVOURITE =
      REQUEST_TO_SUBSCRIBE + 2;
  ...
  public static final int
      REQUEST_ERROR_REASON_INTERNAL_SERVER_ERROR =
      REQUEST_TO_SERVER_ERROR_BASE + 2;
  ...
  public static final int
      REQUEST_ERROR_REASON_PARAMETER_MISSING =
      REQUEST_TO_SERVER_REASON_BASE + 1;
  public static final int
      REQUEST_ERROR_REASON_HTTP_CONNECT_FAIL =
      REQUEST_TO_SERVER_REASON_BASE + 2;
  ...
  public static final int
      REQUEST_ERROR_REASON_JSON_PARSE_EXCEPTION =
      REQUEST_TO_SERVER_REASON_BASE + 5;
  public static final int
      REQUEST_ERROR_REASON_IMAGE_DOWNLOAD_ERROR =
      REQUEST_TO_SERVER_REASON_BASE + 6;
  public static final int
      REQUEST_ERROR_REASON_SERVER_CONNECT_TIMEOUT =
      REQUEST_TO_SERVER_REASON_BASE + 7;
  public static final int
      REQUEST_ERROR_REASON_XML_PARSE_EXCEPTION =
      REQUEST_TO_SERVER_REASON_BASE + 8;
  public static final int
      REQUEST_ERROR_REASON_SERVER_DATA_CORRUPTION =
      REQUEST_TO_SERVER_REASON_BASE + 13;
