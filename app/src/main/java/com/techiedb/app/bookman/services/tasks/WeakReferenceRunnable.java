 ...
 * @since Apr.02.2015
 *
 * Using the WeakReferenceRunnable for restricting the reference for each of the list of <code>Runnable</code> when we
 * used it to implement the customized threads.
 */
