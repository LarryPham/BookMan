...
public class SettingController extends BaseController {
    public static final String TAG = Properties.PREFIX + SettingController.class.getSimpleName();

    public SettingController(BaseActivity activity, BookDataModel inDataModel) {
        super(activity, inDataModel);
    }

    public SettingController(BaseActivity activity, BookDataModel inDataModel, boolean blnFirstRunning) {
