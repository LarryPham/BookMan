 ...
 * @since Dec.19.2014
 */
public class GalleryActivityController extends BaseController {
    public static final String TAG = Properties.PREFIX + GalleryActivityController.class.getSimpleName();

    public GalleryActivityController(BaseActivity activity, BookDataModel inDataModel) {
        super(activity, inDataModel);
    }

    public GalleryActivityController(BaseActivity activity, BookDataModel inDataModel, boolean blnFirstRunning) {
